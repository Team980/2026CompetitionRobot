...
public class AimAndDriveToRightCommand extends Command {
    ...
    public AimAndDriveToRightCommand(
        Swerve swerve,
    ...
    public AimAndDriveToRightCommand(Swerve swerve) {
        this(swerve, () -> 0, () -> 0);
    }
    ...
    private Rotation2d getDirectionToRightField() {
    ...
    private Rotation2d getDirectionToLeftField() {
