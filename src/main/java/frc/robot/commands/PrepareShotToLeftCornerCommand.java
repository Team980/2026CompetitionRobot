...
public class PrepareShotToLeftCornerCommand extends Command {
   ...
   // public static boolean isReadyToShoot;
    public PrepareShotToLeftCornerCommand(Shooter shooter, Hood hood, Supplier<Pose2d> robotPoseSupplier) {
    ...
    private Distance getDistanceToLeftCorner() {
        final Translation2d robotPosition = robotPoseSupplier.get().getTranslation();
        final Translation2d hubPosition = Landmark.LEFT_CORNER.get().getTranslation();
    ...
    @Override
    public void execute() {
        final Distance distanceToHub = getDistanceToLeftCorner();
    ...
    //     builder.addDoubleProperty("Distance to Hub (inches)", () -> distanceHub, (distanceHub) -> getDistanceToLeftCorner());
    // }
