...
public class AimAndDriveToLeftCommand extends Command {
    ...
    public AimAndDriveToLeftCommand(
        Swerve swerve,
    ...
    public AimAndDriveToLeftCommand(Swerve swerve) {
        this(swerve, () -> 0, () -> 0);
    }
    ...
    {
        return getDirectionToLeftField();
    }
    ...
    public void execute() {
        ...
        swerve.setControl(
            fieldCentricFacingAngleRequest
                ...
                .withTargetDirection(getDirectionToLeftField())
        );
