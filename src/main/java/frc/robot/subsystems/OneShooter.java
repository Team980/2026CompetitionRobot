...
public class OneShooter extends SubsystemBase {
    ...
    public Command percentSpinCommand(double percentage) {
        return runOnce(() -> setPercentOutput(percentage))
            .andThen(Commands.waitUntil(this::isVelocityWithinTolerance));
    }

    public Command testSpin(double percentage)
    {
        System.out.println("testSpin");
         return defer(() -> percentSpinCommand(percentage)); 
    }
